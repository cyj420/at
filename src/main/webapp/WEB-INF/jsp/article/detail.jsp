...
<div class="table-box con">
			...
			<tbody>
				...
				<c:if test="${article.extra.file__common__attachment['1'] != null}">
					<tr>
						...
						<td>
							<div class="video-box">
								<video controls src="/usr/file/streamVideo?id=${article.extra.file__common__attachment['1'].id}"></video>
							</div>
						</td>
					</tr>
				</c:if>
				<c:if test="${article.extra.file__common__attachment['2'] != null}">
					<tr>
						...
						<td>
							<div class="video-box">
								<video controls src="/usr/file/streamVideo?id=${article.extra.file__common__attachment['2'].id}"></video>
							</div>
						</td>
					</tr>
				</c:if>
	...
	<h2 class="reply-list-title con">댓글 목록</h2>
	<!-- 여기부터 댓글 리스트 -->
	...
	<script>
		...
		function ReplyList__loadMoreCallback(data){
			...
			// 10초마다 댓글 갱신
			setTimeout(ReplyList__loadMore, 10000);
		}
